 ...
 */
@Component
public class EqualsToProcess extends AbstractExpression<ParseContext> implements InitializingBean {
...
//         */
//        parseContexts.add(
//                ParseContext.builder().opera(ConnectEnum.OR.getConnect()).build()
//        );
//        /**
//         * process right
//         */
...
//        parameterFormatBiz.recursionProcess(parseContexts, rightExpression);
        parseContexts.add(ParseContextFactory.getNode((Expression) expr, parseContexts));
    }
