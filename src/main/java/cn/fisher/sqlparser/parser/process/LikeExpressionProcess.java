 ...
 */
@Component
public class LikeExpressionProcess extends AbstractExpression<ParseContext> implements InitializingBean {
    ...
    protected void handler(Expression expr, CopyOnWriteArrayList<ParseContext> parseContexts) {
        parseContexts.add(
                ParseContextFactory.getLikeNode(expr, parseContexts)
        );
    }
