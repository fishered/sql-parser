...
/**
 * @author fisher
 * @date 2023-08-02: 14:28
 */
@Component
public class LessThanProcess extends AbstractExpression<ParseContext> implements InitializingBean {
    @Override
    protected void handler(Expression expr, CopyOnWriteArrayList<ParseContext> parseContexts) {
        parseContexts.add(
                ParseContextFactory.getLessThanNode(expr, parseContexts)
        );
    }
